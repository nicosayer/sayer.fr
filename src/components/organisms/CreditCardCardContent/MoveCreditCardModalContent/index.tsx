...
export interface MoveCreditCardModalContentProps {
  creditCard: CreditCardDocument;
}

const MoveCreditCardModalContent: FC<MoveCreditCardModalContentProps> = ({
  creditCard,
}) => {
...
export default MoveCreditCardModalContent;
