...
import EditChoreModalContent from "components/organisms/ChoreCardContent/EditChoreModalContent";
import MoveChoreModalContent from "components/organisms/ChoreCardContent/MoveChoreModalContent";
...
const ChoreCardContent: FC<ChoreCardsPropContent> = ({ chore }) => {
...
export default ChoreCardContent;
