...
export interface MoveCredentialModalContentProps {
  credential: CredentialDocument;
}

const MoveCredentialModalContent: FC<MoveCredentialModalContentProps> = ({
  credential,
}) => {
...
export default MoveCredentialModalContent;
